...
В репозитории — готовая обработка `.epf`, а не дерево исходников. Код внутри
открыт: обработка открывается в конфигураторе, читается и правится. Но это
не open source — права на продукт остаются у правообладателя, условия
в [LICENSE.md](LICENSE.md).
